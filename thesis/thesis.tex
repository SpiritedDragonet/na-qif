...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[fontset=windows,type=master,campus=harbin,eqfullwidthparen=true,citetwo=comma]{hithesisbook}
% 此处选项中不要有空格
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 必填选项
...
%%\cleardoublepage % 控制右开页，与前文连续开页时注释掉
% \listoffigures   % 插图目录（按模板要求可关闭）

%%\cleardoublepage % 控制右开页，与前文连续开页时注释掉
% \listoftables    % 表格目录（按模板要求可关闭）
